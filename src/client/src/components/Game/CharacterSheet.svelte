...
<div class="character-sheet-container">
    <div class="character-name">
        <box class="box-with-label">
            <div class="box-main-text">
                <InPlaceEdit bind:value={charName} on:submit={submit('charName')}/>
            </div>
            <div class="box-label">
                Character Name
            </div>
    ...
    <div class="character-class-level">
        <box class="box-with-label" style="flex-grow: 4;">
            <div class="box-main-text">
                <InPlaceEdit bind:value={charClassLevel} editModeWidth="10em" on:submit={submit('charClassLevel')}/>
            </div>
            <div class="box-label">
                Class & Level
            </div>
        ...
        <box class="box-with-label">
            <div class="box-main-text">
                <InPlaceEdit bind:value={charXP} editModeWidth="5em" on:submit={submit('charXP')}/>
            </div>
            <div class="box-label">
                XP
            </div>
    ...
    <box class="character-basic-info">
