...
export const sendSkillCheck: Writable<(modifier: number, skillName: string, charName?: string, entityID?: string, diceType?: string, customID?: string, customFormula?: string, flag?: string, diceAccent?: 'roll-over' | 'roll-under') => Promise<void>> = writable();
